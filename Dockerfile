...
# Install Desal - converter for JSON, TOML, YAML, XML and CSV data formats
RUN sudo wget -qO /usr/local/bin/dasel "https://github.com/TomWright/dasel/releases/latest/download/dasel_linux_amd64" && \
