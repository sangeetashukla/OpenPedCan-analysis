...
if (!identical(sum(is.na(ensg_hugo_df$ensg_id)), as.integer(0))) {
...
if (!identical(sum(is.na(ensg_hugo_df$gene_symbol)), as.integer(0))) {
...
ens_gids <- unique(ensg_hugo_df$ensg_id)
