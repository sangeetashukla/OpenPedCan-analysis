...
for(i in 1:length(rna_library_list)){
  ...
  print(paste0("Number of cancer groups having significant ANOVAs across hallmark pathways for RNA library ", rna_library))
}
...
for(i in 1:length(rna_library_list)){
  ...
  # print out information
  print(paste0("Number of harmonized diagnosis having significant ANOVAs across hallmark pathways for RNA library ", rna_library))
