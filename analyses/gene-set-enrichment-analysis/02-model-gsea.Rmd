...
metadata_file <- file.path(data_dir, "histologies-testing.tsv")
...
for(i in 1:length(rna_library_list)){
  ...
  readr::write_tsv(harmonized_diagnosis_model_results[["anova"]], harmonized_diagnosis_anova_outpaths[[i]])
  readr::write_tsv(cancer_group_model_results[["tukey"]],  cancer_group_tukey_outpaths[[i]])
  readr::write_tsv(harmonized_diagnosis_model_results[["tukey"]], harmonized_diagnosis_anova_outpaths[[i]])
