...
histology <- histology %>% 
  dplyr::mutate(
    short_histology = dplyr::case_when(
      cohort == "GMKF" ~ pathology_diagnosis,
      cohort == "TARGET" ~ pathology_diagnosis,
      cohort == "TCGA" ~ pathology_diagnosis,
    ...
    broad_histology = dplyr::case_when(
      ...
      short_histology == "Liver Hepatocellular Carcinoma" ~ "Hepatic tumor",
      short_histology == "Lymphoid Neoplasm Diffuse Large B-cell Lymphoma" ~ "Hematologic malignancy",
      short_histology == "Kidney Renal Clear Cell Carcinoma" ~ "Renal tumor",
      short_histology == "Kidney Renal Papillary Cell Carcinoma" ~ "Renal tumor",
      short_histology == "Kidney Chromophobe" ~ "Renal tumor",
      short_histology == "Stomach Adenocarcinoma" ~ "Gastric tumor",
...
histology<- histology %>%
  ...
  dplyr::mutate(cancer_group = case_when(
    ...
    cohort == "GMKF" ~ short_histology,
    cohort == "TARGET" ~ short_histology,
    cohort == "TCGA" ~ short_histology,
