...
# add broad_histology and short_histology for TARGET and NBL-GMKF samples
histology <- histology %>% 
  dplyr::mutate(
    short_histology = dplyr::case_when(
      ...
      pathology_diagnosis == "Kidney Clear Cell Sarcoma of the Kidney" ~ "Clear cell sarcoma of the kidney",
