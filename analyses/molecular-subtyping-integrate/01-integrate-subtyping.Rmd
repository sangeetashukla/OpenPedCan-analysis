...
histology_cg <- histology %>%
  ...
  dplyr::mutate(cancer_group = case_when(broad_histology %in% c("Benign tumor", "Other", "Non-tumor") ~ NA_character_,
  ...
  dplyr::mutate(cancer_group = case_when(
    ...
    #cancer_group == "Kidney Rhabdoid Tumor" ~ "Rhabdoid tumor",
   # cancer_group == "Kidney Wilms Tumor" ~ "Wilms tumor",
    ...
    cancer_group == "Acute Promyelocytic Leukemia" ~ "Acute Myeloid Leukemia",
...
# Add file of unique cancer groups
cancer_groups <- histology_cg %>%
  ...
  write_tsv("results/cancer_groups.txt", col_names = F)
