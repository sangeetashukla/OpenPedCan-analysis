...
#merged_eh_df <- distinct(bind_rows(v28_eh_df, v38_eh_df, open_ped`_can_v7_eh_df))
merged_eh_df <- distinct(bind_rows(v27_eh_df, v28_eh_df, v36_eh_df, v38_eh_df, v39_eh_df, open_ped_can_v7_eh_df))
