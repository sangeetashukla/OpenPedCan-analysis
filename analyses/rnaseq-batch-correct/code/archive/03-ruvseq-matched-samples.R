...
pca_p <- edaseq_plot(object = seq_expr_set, title = "Before normalization", type = "PCA", color_var = "patient_id", shape_var = "rna_library")
umap_p <- edaseq_plot(object = seq_expr_set, title = "Before normalization", type = "UMAP", color_var = "patient_id", shape_var = "rna_library")
boxplot_p <- box_plots(object = seq_expr_set, title = "Before normalization", facet_var = "patient_id", color_var = "rna_library")
...
pca_p_norm <- edaseq_plot(object = seq_expr_set, title = "After UQ normalization", type = "PCA", color_var = "patient_id", shape_var = "rna_library")
umap_p_norm <- edaseq_plot(object = seq_expr_set, title = "After UQ normalization", type = "UMAP", color_var = "patient_id", shape_var = "rna_library")
boxplot_p_norm <- box_plots(object = seq_expr_set, title = "After UQ normalization", facet_var = "patient_id", color_var = "rna_library")
...
ruvg_test(seq_expr_set = seq_expr_set, k_val = 1:k_value, 
          ...
          design_variable = "patient_id",
          color_var = "patient_id", shape_var = "rna_library")
...
dds <- DESeq2::DESeqDataSetFromMatrix(countData = round(counts(seq_expr_set)), colData =  data.frame(patient_id, rna_library), design = design)
...
y <- edgeR::DGEList(counts = counts(seq_expr_set), group = rna_library)
...
# export results
lrt <- edgeR::glmLRT(edger_fit, coef = grep('rna_library', colnames(edger_fit$coefficients))) # for RNA library
