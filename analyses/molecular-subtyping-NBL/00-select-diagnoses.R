...
# and pathology free text diagnosis terms to select NBL
# samples for downstream NBL subtyping analysis and save 
# the json file in nbl-subset folder
...
hist <- read_tsv(file.path(root_dir, "data", "histologies-base.tsv"), guess_max = 100000)
