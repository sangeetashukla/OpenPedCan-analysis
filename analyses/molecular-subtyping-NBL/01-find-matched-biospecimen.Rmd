...
MYCN_dna_df %>%readr::write_tsv(file.path(results_dir,"mycn_nbl_dna_biospecimen.tsv"))
MYCN_rna_df %>%readr::write_tsv(file.path(results_dir,"mycn_nbl_rna_biospecimen.tsv"))
```
