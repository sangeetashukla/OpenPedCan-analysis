...
---
In this notebook we load the table `input/mycn_nbl_subset_data.tsv` and find the biospecimens which
have matched DNA and RNA IDs. We store these biospecimens as a table in 
`input/mycn_nbl_matched_biospecimen.tsv`.  The script also creates two tables 
`input/mycn_nbl_dna_biospecimen.tsv` and `input/mycn_nbl_rna_biospecimen.tsv` which contain 
...
biospecimens files  into input dir
