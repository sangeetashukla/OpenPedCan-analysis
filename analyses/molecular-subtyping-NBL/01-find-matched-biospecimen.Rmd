...
---
In this notebook we load the table `results/mycn_nbl_subset_data.tsv` and find the biospecimens which
have matched DNA and RNA IDs. We store these biospecimens as a table in 
`results/mycn_nbl_matched_biospecimen.tsv`.  The script also creates two tables 
`results/mycn_nbl_dna_biospecimen.tsv` and `results/mycn_nbl_rna_biospecimen.tsv` which contain 
...
MYCN_DNA_RNA_FILTERED_DF <- MYCN_DNA_RNA_DF %>% select(Kids_First_Biospecimen_ID_DNA,
                                                       ...
                                                       MYCN_CN.x,MYCN_CN.y,MYCN_TPM.x,
                                                       MYCN_TPM.y,MYCN_CN_status.x,MYCN_CN_status.y, match_id)
...
colnames(MYCN_DNA_RNA_FILTERED_DF)<-c("Kids_First_Biospecimen_ID_DNA","Kids_First_Biospecimen_ID_RNA",
                                      ...
                                      "pathology_free_text_diagnosis","MYCN_CN","MYCN_TPM",
...
biospecimens files  into results dir
```{r write alteration table}
MYCN_DNA_RNA_FILTERED_DF%>%readr::write_tsv(file.path(input_dir,"mycn_nbl_matched_biospecimen.tsv"))
MYCN_dna_df %>%readr::write_tsv(file.path(input_dir,"mycn_nbl_dna_biospecimen.tsv"))
MYCN_rna_df %>%readr::write_tsv(file.path(input_dir,"mycn_nbl_rna_biospecimen.tsv"))
```
