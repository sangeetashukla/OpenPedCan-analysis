...
TPM_MYCN_data <- as.data.frame(t(expression_mat["MYCN", intersect(hist_subset$Kids_First_Biospecimen_ID,
...
MYCN_DF %>% 
  readr::write_tsv(file.path(input_dir, "mycn_nbl_subset_data.tsv"))
```
