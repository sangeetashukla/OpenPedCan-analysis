...
for (iter in 1:dim(QC_df)[1]){
  ...
  gmkf_values <- c(alteration_subtyped_df$MYCN_TPM[index_gmkf],
  ...
  target_values <- c(alteration_subtyped_df$MYCN_TPM[index_target],
                     alteration_subtyped_df$MYCN_CN_status[index_target],
                     alteration_subtyped_df$molecular_subtype[index_target])
 values_from_subtype_table<- rbind(values_from_subtype_table,c(gmkf_values,target_values))
}
