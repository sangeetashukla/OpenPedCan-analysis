...
1. `alteration_table_without_subtype.tsv`: this table is contains all the biospecimens  for neuroblastama,
...
table (`alteration_table_without_subtype.tsv`) specifies the reasons for why the particular biospecimen could not 
be subtyped. 
