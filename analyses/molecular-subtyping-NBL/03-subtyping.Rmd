...
```{r}
alteration_df<-readr::read_tsv(file.path(input_dir, "alteration_table_without_molecular_subtype.tsv"),
                               guess_max = 100000)
...
molecular_subtype_table%>%readr::write_tsv(file.path(results_dir, "neuroblastoma_molecular_subtypes.tsv"))
```

#Remove intermediate files that are not required
```{r names of intermediate files to be deleted}
# 
# file_names_intermediate<- c(paste(input_dir, "/mycn_nbl_subset_data.tsv",sep=""),
#                             paste(input_dir,"/mycn_nbl_matched_biospecimen.tsv",sep=""),
#                             paste(input_dir,"/mycn_nbl_dna_biospecimen.tsv",sep=""),
#                             paste(input_dir,"/mycn_nbl_rna_biospecimen.tsv",sep=""),
#                             paste(input_dir,"/alteration_table_without_molecular_subtype.tsv",sep=""))
