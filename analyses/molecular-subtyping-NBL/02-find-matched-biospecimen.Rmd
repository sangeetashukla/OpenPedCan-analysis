...
MYCN_DNA_RNA_FILTERED_DF %>% 
  readr::write_tsv(file.path(input_dir,"mycn_nbl_matched_biospecimen.tsv"))
MYCN_dna_df %>% 
  readr::write_tsv(file.path(input_dir,"mycn_nbl_dna_biospecimen.tsv"))
MYCN_rna_df %>% 
  readr::write_tsv(file.path(input_dir,"mycn_nbl_rna_biospecimen.tsv"))
```
