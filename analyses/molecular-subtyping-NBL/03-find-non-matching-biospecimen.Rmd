...
`input/mycn_nbl_matched_biospecimen.tsv` and joined table called 
`input/alteration_table_without_subtype.tsv` which contains the list of all the NBL-MYCN 
...
#input directory
input_dir <- file.path(root_dir, "analyses","molecular-subtyping-NBL","input")
...
MYCN_DF<-readr::read_tsv(file.path(input_dir, "mycn_nbl_subset_data.tsv"),guess_max = 100000)
MYCN_DNA_RNA_FILTERED_DF<-readr::read_tsv(file.path(input_dir,"mycn_nbl_matched_biospecimen.tsv"),guess_max = 100000)
...
MYCN_dna_df<-readr::read_tsv(file.path(input_dir, "mycn_nbl_dna_biospecimen.tsv"),guess_max = 100000)
MYCN_rna_df<-readr::read_tsv(file.path(input_dir, "mycn_nbl_rna_biospecimen.tsv"),guess_max = 100000)
...
Write NBL-MYCN biospecimen to subtyped into the input folder
```{r}
alteration_df%>%readr::write_tsv(file.path(input_dir, "alteration_table_without_molecular_subtype.tsv"))
```