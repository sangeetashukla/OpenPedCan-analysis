...
hist_filtered_df <- hist_filtered_df %>% filter(experimental_strategy == "WGS" | experimental_strategy == "WXS" | experimental_strategy == "Targeted Sequencing" | experimental_strategy=="RNA-Seq")
...
MYCN_DF<- left_join(hist_filtered_df,all_MYCN_biospecimen_ID,by="Kids_First_Biospecimen_ID") ##### CHANGE TO LEFT
