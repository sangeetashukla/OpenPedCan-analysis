...
DNA_only_MYCN_df <- DNA_only_MYCN_df %>% select(Kids_First_Biospecimen_ID,Kids_First_Participant_ID,gene_symbol,
                                                pathology_diagnosis,pathology_free_text_diagnosis,copy_number,
                                                MYCN_TPM,status)
colnames(DNA_only_MYCN_df)[1]<- "Kids_First_Biospecimen_ID_DNA"


RNA_only_MYCN_df<- MYCN_DF %>% filter(Kids_First_Biospecimen_ID %in% RNA_IDs_MYCN_Non_Match$Kids_First_Biospecimen_ID_DNA)

RNA_only_MYCN_df <- RNA_only_MYCN_df %>% select(Kids_First_Biospecimen_ID,Kids_First_Participant_ID,gene_symbol,
                                                pathology_diagnosis,pathology_free_text_diagnosis,copy_number,
                                                MYCN_TPM,status)
colnames(RNA_only_MYCN_df)[1]<- "Kids_First_Biospecimen_ID_RNA"


#select(Kids_First_Biospecimen_ID_DNA,Kids_First_Biospecimen_ID_RNA,Kids_First_Participant_ID.x,Kids_First_Participant_ID.y,
#                                              gene_symbol.x,gene_symbol.y,
#                                              pathology_diagnosis.x,pathology_diagnosis.y,
#                                              pathology_free_text_diagnosis.x,pathology_free_text_diagnosis.y,
#                                              copy_number.x,copy_number.y,MYCN_TPM.x,MYCN_TPM.y,status.x,status.y, match_id)
