...
bar_plot1+ geom_hline(aes(yintercept=156.12,linetype = "Suggested Amp Cutoff"),color = "black",size=2) #TARGET-30-PAPKXS-01A-01D	
...
bar_plt2+ geom_hline(aes(yintercept=156.12,linetype = "Suggested Amp Cutoff"),color = "violet",size=2) #TARGET-30-PAPKXS-01A-01D	
