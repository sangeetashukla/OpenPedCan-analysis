...
#Add the satus and copy Number to these samples. Adding the information if available, so we do a left join with respect to hist_filtered_df as we don't want to discard any biospecimen of MYCN-NBL for which Status and copy number is not avaialable
