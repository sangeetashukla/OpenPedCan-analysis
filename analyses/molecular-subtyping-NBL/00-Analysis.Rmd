...
alteration_df<-alteration_df %>%mutate(subtype = case_when(status =="amplification" & pathology_free_text_diagnosis=="MYCN amp" 
                                                           ~ "NBL, MYCN amplified",
                                                           status =="amplification" & pathology_free_text_diagnosis %in% 
...
index_clinical_amplified <- which(alteration_df$status != "amplification" & alteration_df$pathology_free_text_diagnosis=="MYCN amp")
...
```{r plots}
plot_chr19(cnv_cnvkit_df,clincal_amplified_IDs[1])
```
```{r}
plot_chr19(cnv_cnvkit_df,clincal_amplified_IDs[2])
```
```{r}
plot_chr19(cnv_cnvkit_df,clincal_amplified_IDs[3])
```
