...
analysis_dir <- file.path(root_dir, "analylsis", "pedcbio-cnv-prepare")
```
...
### Combine consensus and cnvkit for XY and autosomes
```{r}
# combine xy 
