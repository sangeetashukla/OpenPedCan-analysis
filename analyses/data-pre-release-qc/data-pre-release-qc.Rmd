...
if (length(missing_ids) > 0) {
  readr::write_lines(missing_ids,
                     file.path(results_dir, 
                               "gene-counts-rsem-expected_count-collapsed-missing-samples.txt"))
}
...
if (length(missing_ids) > 0) {
  readr::write_lines(missing_ids,
                     file.path(results_dir, 
                               "gene-expression-rsem-tpm-collapsed-missing-samples.txt"))
}
...
if (length(missing_ids) > 0) {
  readr::write_lines(missing_ids,
                     file.path(results_dir, 
                               "tcga-gene-counts-rsem-expected_count-collapsed-missing-samples.txt"))
}
...
if (length(missing_ids) > 0) {
  readr::write_lines(missing_ids,
                     file.path(results_dir, 
                               "tcga-gene-expression-rsem-tpm-collapsed-missing-samples.txt"))
}
...
print(paste("Genes not matching all expression matrices =", length(all_genes) - length(intersect_genes) ))
```
...
missing_ids <- hist_df %>%
  ...
  setdiff(biospecimen_ids)
if (length(missing_ids) > 0) {
  readr::write_lines(missing_ids, file.path(results_dir, 
                                            "cnv-cnvkit.seg-missing-samples.txt"))
}
...
if (length(missing_ids) > 0) {
  readr::write_lines(missing_ids, file.path(results_dir, 
                                            "cnv-controlfreec-missing-samples.txt"))
}
...
if (length(missing_ids) > 0) {
  readr::write_lines(missing_ids, file.path(results_dir, "cnvkit_with_status-missing-samples.txt"))
}
...
if (length(missing_ids) > 0) {
  readr::write_lines(missing_ids, file.path(results_dir, 
                                            "consensus_wgs_plus_cnvkit_wxs_autosomes_missing_samples.txt"))
}
...
if (length(missing_ids) > 0) {
  readr::write_lines(missing_ids, file.path(results_dir, 
                                            "consensus_wgs_plus_cnvkit_wxs_x_and_y_missing_samples.txt"))
}
...
if (length(missing_ids) > 0) {
  readr::write_lines(missing_ids, file.path(results_dir, 
                                            "snv-mutation-tmb-all-missing-samples.txt"))
}
...
if (length(missing_ids) > 0) {
  readr::write_lines(missing_ids, file.path(results_dir, 
                                            "snv-mutation-tmb-coding-missing-samples.txt"))
}
...
if (length(missing_ids) > 0) {
  readr::write_lines(missing_ids, file.path(results_dir, 
                                            "fusion_summary_embryonal_foi-missing-samples.txt"))
}
...
if (length(missing_ids) > 0) {
  readr::write_lines(missing_ids, file.path(results_dir, 
                                            "fusion_summary_ependymoma_foi-missing-samples.txt"))
}
...
if (length(missing_ids) > 0) {
  readr::write_lines(missing_ids, file.path(results_dir, 
                                            "fusion_summary_ewings_foi-missing-samples.txt"))
}
...
if (length(missing_ids) > 0) {
  readr::write_lines(missing_ids, file.path(results_dir, 
                                            "fusion_summary_lgat_foi-missing-samples.txt"))
}
...
if (length(missing_ids) > 0) {
  readr::write_lines(missing_ids, file.path(results_dir, 
                                            "biospecimen_id_to_bed_map-missing-samples.txt"))
}
...
if (length(missing_sex_estimate) > 0) {
  readr::write_lines(missing_sex_estimate, file.path(results_dir, 
                                            "wgs-biospecimen-missing-sex_estimate.txt"))
}
...
if (length(missing_sex_estimate) > 0) {
  readr::write_lines(missing_sex_estimate, file.path(results_dir, 
                                            "wxspanel-biospecimen-missing-transferred-wgs-sex_estimate.txt"))
}
