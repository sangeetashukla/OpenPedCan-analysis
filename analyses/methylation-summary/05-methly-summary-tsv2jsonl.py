...
"""
05-methly-summary-tsv2jsonl.py
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
def read_parameters():
     p = argparse.ArgumentParser(description=("The 05-methly-summary-tsv2jsonl.py script converts methylation summary table from TSV format to JSONL."), formatter_class=argparse.RawTextHelpFormatter)
     ...
     p.add_argument('-v', '--version', action='version', version="03-methyl-tpm-correlation.py version {} ({})".format(__version__, __date__), help="Print the current 05-methly-summary-tsv2jsonl.py version and exit\n\n")
     return p.parse_args()
