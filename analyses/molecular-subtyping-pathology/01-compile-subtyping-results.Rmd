...
The molecular subtyping information from these tumors will go into the v10 release, and we will update `integrated_diagnosis`, `short_histology`, `broad_histology`, and `Notes` columns now, until SQL rules PR [#748](https://github.com/AlexsLemonade/OpenPBTA-analysis/issues/748) goes in later.
...
The EWS results were updated in V18 of OpenPBTA. Adding integrated dx, broad hist, short hist here for now.
...
HGG subtyping was updated with V18 of OpenPBTA.
