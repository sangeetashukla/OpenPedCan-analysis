...
hgg_results_df <- bind_exp_strategies(hgg_results_df) %>%
  ...
  mutate(integrated_diagnosis = case_when(molecular_subtype == "DMG, H3 K28"~ "Diffuse midline glioma, H3 K28-mutant",
                                          ...
                                          molecular_subtype == "HGG, H3 G35" ~ "Diffuse hemispheric glioma, H3 G35-mutant",
                                          molecular_subtype == "HGG, H3 G35, TP53 activated" ~ "Diffuse hemispheric glioma, H3 G35-mutant",
                                          molecular_subtype == "HGG, H3 G35, TP53 loss" ~ "Diffuse hemispheric glioma, H3 G35-mutant",
                                          molecular_subtype == "HGG, H3 wildtype" ~ "High-grade glioma, IDH-wildtype and H3-wildtype",
                                          molecular_subtype == "HGG, H3 wildtype, TP53 activated" ~ "High-grade glioma, IDH-wildtype and H3-wildtype",
                                          molecular_subtype == "HGG, H3 wildtype, TP53 loss" ~ "High-grade glioma, IDH-wildtype and H3-wildtype",
                                          molecular_subtype == "HGG, IDH"~ "High-grade glioma, IDH-mutant",
                                          molecular_subtype == "HGG, IDH, TP53 loss"~ "High-grade glioma, IDH-mutant",
                                          molecular_subtype == "HGG, IDH, TP53 activated"~ "High-grade glioma, IDH-mutant",
                                          # account for IGH subtypes
                                          molecular_subtype == "IHG, NTRK-altered"~ "Infant-type hemispheric glioma, NTRK-altered",
                                          molecular_subtype == "IHG, ALK-altered"~ "Infant-type hemispheric glioma, ALK-altered",
                                          molecular_subtype == "IHG, ROS1-altered"~ "Infant-type hemispheric glioma, ROS1-altered",
                                          molecular_subtype == "IHG, MET-altered"~ "Infant-type hemispheric glioma, MET-altered",
                                          TRUE~ NA_character_),
