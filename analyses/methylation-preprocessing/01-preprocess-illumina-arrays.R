...
# Set path to module, data, metadata, and results directories
...
cancer_type <- basename(base_dir)
message("===============================================")
message(c("Preprocessing ", cancer_type, " sample array data files..."))
message("===============================================\n")

# Check of the array data sub-directory exists
array_data_dir <- file.path(data_dir, cancer_type)
...
m_values_file <- file.path(results_dir,
                           paste0(cancer_type, "-m-values-methylation.tsv"))
...
message(paste(cancer_type,"samples methylation 'M-values'saved to:\n", 
              m_values_file, "\n"))

# write Beta-values methylation summary table to TSV file
beta_values_file <- file.path(results_dir,
                           paste0(cancer_type, "-beta-values-methylation.tsv"))
...
rm(summary_table)
# print out completion message
message(paste(cancer_type, "samples methylation 'Beta-values'saved to:\n", 
              beta_values_file, "\n"))
