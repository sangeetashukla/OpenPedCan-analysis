...
plotNcg<-function(standardFusionCalls,filterN,plot_title){
  # get count of number of grouping varaible of full histology per FusionName
...
# select fusions that will be filtered (found in more than 4 grouping variables for base histology)
FusionInNbh<-FusionInNcg[FusionInNcg$count>countBaseGroup,]
FusionInNbh
